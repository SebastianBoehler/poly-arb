...
namespace polymarket
{
    ...
    void HttpClient::init()
    {
        ...
        // SSL options - disable verification by default for proxy compatibility
        // Bright Data residential proxies require -k flag equivalent
        curl_easy_setopt(curl_, CURLOPT_SSL_VERIFYPEER, 0L);
        curl_easy_setopt(curl_, CURLOPT_SSL_VERIFYHOST, 0L);

        // Default headers - include User-Agent to avoid Cloudflare blocks
